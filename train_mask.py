...
def main(args):
    ...
    model = demo_util.get_VQGAN_mask(config).to(device)  
    model.init_from_ckpt("/private/task/wubin/order_VQGAN/result/003-mask/checkpoints/0020000.pt")  
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="configs/OD_VQGAN_mask.yaml")

...
def txt_to_indices(path):
    path_to_yaml="data/image_net_idex/train/imagenet_idx_to_synset.yml"
...
class ImageNetBase(Dataset):
    ...
    def _filter_relpaths(self, relpaths):
        ...
        if "sub_indices" in self.config:
            ...
            indices = txt_to_indices(self.config["sub_indices"])
    ...
    def _prepare_idx_to_synset(self):
        ...
        self.idx2syn = os.path.join(self.write_root, "imagenet_idx_to_synset.yaml")
    ...
    def _load(self):
        ...
        transform=[
            transforms.Resize(size=256, interpolation=transforms.InterpolationMode.BICUBIC, max_size=None, antialias=True),
...
if __name__ == "__main__":
    config = {"is_eval": False, "size": 512, "sub_indices": 'data/image_net_idex/imagenet100.txt'}
